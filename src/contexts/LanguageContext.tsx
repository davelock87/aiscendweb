...
const translations = {
  en: {
    ...
    // Integration Cards - Popular Integrations
    'integrations.databases.title': 'Databases',
    'integrations.databases.desc': 'MySQL, PostgreSQL, MongoDB, Redis, and more',
    'integrations.email.title': 'Email Services',
    'integrations.email.desc': 'Gmail, Outlook, SMTP, SendGrid, Mailchimp',
    'integrations.communication.title': 'Communication',
    'integrations.communication.desc': 'Slack, Discord, Telegram, WhatsApp, Teams',
    'integrations.calendar.title': 'Calendar',
    'integrations.calendar.desc': 'Google Calendar, Outlook Calendar, Calendly',
    'integrations.documents.title': 'Documents',
    'integrations.documents.desc': 'Google Docs, Notion, Airtable, Excel',
    'integrations.ecommerce.title': 'E-commerce',
    'integrations.ecommerce.desc': 'Shopify, WooCommerce, Stripe, PayPal',
    'integrations.cloud.title': 'Cloud Services',
    'integrations.cloud.desc': 'AWS, Google Cloud, Azure, DigitalOcean',
    'integrations.development.title': 'Development',
    'integrations.development.desc': 'GitHub, GitLab, Bitbucket, Jira',

    // Integration Cards - Enterprise Solutions
    'integrations.hr.title': 'HR Automation',
    'integrations.hr.desc': 'Streamline onboarding, time tracking, and employee management',
    'integrations.finance.title': 'Finance & Operations',
    'integrations.finance.desc': 'Automate invoicing, expense tracking, and reporting',
    'integrations.sales.title': 'Sales & Marketing',
    'integrations.sales.desc': 'CRM integration, lead tracking, and campaign automation',
    'integrations.analytics.title': 'Analytics & Reporting',
    'integrations.analytics.desc': 'Custom dashboards and automated reporting',
    'integrations.security.title': 'Security & Compliance',
    'integrations.security.desc': 'Data protection, audit logs, and access control',
    'integrations.api.title': 'API Management',
    'integrations.api.desc': 'Custom integrations and webhook management',
    'integrations.ai.title': 'AI & Machine Learning',
    'integrations.ai.desc': 'Intelligent automation and predictive analytics',
    'integrations.supply.title': 'Supply Chain',
    'integrations.supply.desc': 'Inventory management and logistics automation',
  ...
  es: {
    ...
    // Integration Cards - Popular Integrations
    'integrations.databases.title': 'Bases de Datos',
    'integrations.databases.desc': 'MySQL, PostgreSQL, MongoDB, Redis y más',
    'integrations.email.title': 'Servicios de Email',
    'integrations.email.desc': 'Gmail, Outlook, SMTP, SendGrid, Mailchimp',
    'integrations.communication.title': 'Comunicación',
    'integrations.communication.desc': 'Slack, Discord, Telegram, WhatsApp, Teams',
    'integrations.calendar.title': 'Calendario',
    'integrations.calendar.desc': 'Google Calendar, Outlook Calendar, Calendly',
    'integrations.documents.title': 'Documentos',
    'integrations.documents.desc': 'Google Docs, Notion, Airtable, Excel',
    'integrations.ecommerce.title': 'E-commerce',
    'integrations.ecommerce.desc': 'Shopify, WooCommerce, Stripe, PayPal',
    'integrations.cloud.title': 'Servicios en la Nube',
    'integrations.cloud.desc': 'AWS, Google Cloud, Azure, DigitalOcean',
    'integrations.development.title': 'Desarrollo',
    'integrations.development.desc': 'GitHub, GitLab, Bitbucket, Jira',

    // Integration Cards - Enterprise Solutions
    'integrations.hr.title': 'Automatización de RRHH',
    'integrations.hr.desc': 'Optimiza incorporación, seguimiento de tiempo y gestión de empleados',
    'integrations.finance.title': 'Finanzas y Operaciones',
    'integrations.finance.desc': 'Automatiza facturación, seguimiento de gastos y reportes',
    'integrations.sales.title': 'Ventas y Marketing',
    'integrations.sales.desc': 'Integración CRM, seguimiento de leads y automatización de campañas',
    'integrations.analytics.title': 'Análisis y Reportes',
    'integrations.analytics.desc': 'Dashboards personalizados y reportes automatizados',
    'integrations.security.title': 'Seguridad y Cumplimiento',
    'integrations.security.desc': 'Protección de datos, registros de auditoría y control de acceso',
    'integrations.api.title': 'Gestión de APIs',
    'integrations.api.desc': 'Integraciones personalizadas y gestión de webhooks',
    'integrations.ai.title': 'IA y Machine Learning',
    'integrations.ai.desc': 'Automatización inteligente y análisis predictivo',
    'integrations.supply.title': 'Cadena de Suministro',
    'integrations.supply.desc': 'Gestión de inventario y automatización logística',
